...
(async () => {
  ...
  const POC_COMPLETED = ['automation-native-webdriver', 'platformversion-identity', 'navigator-identity', 'hardwareConcurrency-identity', 'deviceMemory-identity', 'maxTouchPoints-identity'];
