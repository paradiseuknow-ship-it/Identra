...
npm test        # 全量回归（runRegression.js 204 项 + phase9 197 项双护栏）
```
...
| 评估基准 | 冻结 v2 任务池（100 任务）+ canonical240 基线 + 双回归护栏（204/0 + OK=197/BAD=0，全绿） |
