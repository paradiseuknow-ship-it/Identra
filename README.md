...
npm test        # 全量回归（runRegression.js 200 项 + phase9 193 项双护栏）
```
...
| 评估基准 | 冻结 v2 任务池（100 任务）+ canonical240 基线 + 双回归护栏（200/0 + OK=193/BAD=0，全绿） |
