...
npm test        # 全量回归（runRegression.js 206 项 + phase9 199 项双护栏）
```
...
| 评估基准 | 冻结 v2 任务池（100 任务）+ canonical240 基线 + 双回归护栏（206/0 + OK=199/BAD=0，全绿） |
