...
npm test        # 全量回归（runRegression.js 155 项 + phase9 148 项双护栏）
```
...
- **回归护栏**：runRegression **155/0** + phase9 **OK=148/BAD=0**（C51 后历史最佳；fp16b launch 套件 profile 目录已随 FPB_DATA_DIR tmp 隔离，消除跨实例 Chrome 锁争用 flaky）
